...
class GRUModel(BaseModel):
    """
    Stacked GRU model for multi-variate stock price forecasting.
    GRU is a lighter alternative to LSTM with fewer parameters but similar performance.
    ...
    def fit(self, X: np.ndarray, y: np.ndarray):
        """Train the GRU on pre-built (X_train, y_train) arrays."""
